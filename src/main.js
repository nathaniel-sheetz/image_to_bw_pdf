...
const resetCornerViewBtn = document.getElementById('reset-corner-view')
...
const resetCropViewBtn = document.getElementById('reset-crop-view')
...
resetCornerViewBtn.addEventListener('click', () => cornerUI?.resetView())
...
resetCropViewBtn.addEventListener('click', () => rectangularCropUI?.resetView())
